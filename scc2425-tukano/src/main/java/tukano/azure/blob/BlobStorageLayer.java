package main.java.tukano.azure.blob;
...
public class BlobStorageLayer {
        ...
        public static String storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=scc60353;AccountKey=g5h9LhplKvWgDtLtLyLzfPwxpwaxir3abHxIj/nDh0dZAibIDsEMrpCxdn+PfxrrTAyfobZ50oaS+AStH1uIVw==;EndpointSuffix=core.windows.net";

        private static BlobStorageLayer instance;

        public synchronized BlobStorageLayer getInstance() {
            if (instance != null)
                return instance;
        ...
        public BlobStorageLayer(BlobContainerClient client) {
            this.client = client;
        }
